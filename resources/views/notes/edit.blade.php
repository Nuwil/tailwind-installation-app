    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <form action="{{ route('notes.update', $note) }}" method="POST" class="space-y-6 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title', $note->title) }}" class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                @error('title')
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Update Note</button>
