    ...
    <div class="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100">
        <header class="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                <a href="{{ route('home') }}" class="text-lg font-semibold tracking-tight text-slate-900">Tailwind Notes</a>
        ...
        <footer class="border-t border-slate-200 bg-white/90 py-6">
            <div class="mx-auto max-w-7xl px-4 text-center text-sm text-slate-500 sm:px-6">
                Built with Laravel and Tailwind for a clean, responsive experience.
            </div>
        </footer>
    </div>
</body>
